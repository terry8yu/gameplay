    ...
    : _scene(NULL), _formNode(NULL), _formNodeParent(NULL), _formSelect(NULL), _activeForm(NULL), _gamepad(NULL), _keyFlags(0)
{
    ...
    {
        "res/forms/formBasicControls.form",
        "res/forms/formScrolling.form",
        "res/forms/formFlowLayout.form",
        "res/forms/formVerticalLayout.form",
        "res/forms/formZOrder.form",
    };
...
void FormsSample::drawSplash(void* param)
{
...
void FormsSample::initialize()
{
    ...
    displayScreen(this, &FormsSample::drawSplash, NULL, 1000L);

    setMultiTouch(true);
    setVsync(false);

    _formSelect = Form::create("res/forms/formSelect.form");
...
void FormsSample::formChanged()
{
    ...
    _activeForm->setAlignment(Control::ALIGN_BOTTOM_HCENTER);
